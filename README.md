...
Download the data on this website:[replica](https://cvg-data.inf.ethz.ch/nice-slam/data). Note that the Replica data is generated by the authors of iMAP (but hosted by the authors of NICE-SLAM). Please cite iMAP if you use the data.
